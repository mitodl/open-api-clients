...
export const ContentFileSearchApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async contentFileSearchRetrieve(aggregations?: Array<ContentFileSearchRetrieveAggregationsEnum>, content_feature_type?: Array<string>, id?: Array<number>, limit?: number, offered_by?: Array<ContentFileSearchRetrieveOfferedByEnum>, offset?: number, platform?: Array<ContentFileSearchRetrievePlatformEnum>, q?: string, resource_id?: Array<number>, run_id?: Array<number>, sortby?: ContentFileSearchRetrieveSortbyEnum, topic?: Array<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SearchResponse>> {
...
export const ContentFileSearchApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        contentFileSearchRetrieve(requestParameters: ContentFileSearchApiContentFileSearchRetrieveRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<SearchResponse> {
...
export const ContentfilesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        contentfilesList: async (learning_resource_id2: number, content_feature_type?: string, learning_resource_id?: number, learning_resource_readable_id?: string, limit?: number, offered_by?: ContentfilesListOfferedByEnum, offset?: number, platform?: ContentfilesListPlatformEnum, run_id?: number, run_readable_id?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'learning_resource_id2' is not null or undefined
            assertParamExists('contentfilesList', 'learning_resource_id2', learning_resource_id2)
            const localVarPath = `/api/v1/contentfiles/`
                .replace(`{${"learning_resource_id"}}`, encodeURIComponent(String(learning_resource_id2)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            if (learning_resource_readable_id !== undefined) {
                localVarQueryParameter['learning_resource_readable_id'] = learning_resource_readable_id;
            }
...
export const ContentfilesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async contentfilesList(learning_resource_id2: number, content_feature_type?: string, learning_resource_id?: number, learning_resource_readable_id?: string, limit?: number, offered_by?: ContentfilesListOfferedByEnum, offset?: number, platform?: ContentfilesListPlatformEnum, run_id?: number, run_readable_id?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedContentFileList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.contentfilesList(learning_resource_id2, content_feature_type, learning_resource_id, learning_resource_readable_id, limit, offered_by, offset, platform, run_id, run_readable_id, options);
            const index = configuration?.serverIndex ?? 0;
...
export const ContentfilesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        contentfilesList(requestParameters: ContentfilesApiContentfilesListRequest, options?: RawAxiosRequestConfig): AxiosPromise<PaginatedContentFileList> {
            return localVarFp.contentfilesList(requestParameters.learning_resource_id2, requestParameters.content_feature_type, requestParameters.learning_resource_id, requestParameters.learning_resource_readable_id, requestParameters.limit, requestParameters.offered_by, requestParameters.offset, requestParameters.platform, requestParameters.run_id, requestParameters.run_readable_id, options).then((request) => request(axios, basePath));
        },
        /**
         * Viewset for ContentFiles
         * @summary Retrieve
...
export class ContentfilesApi extends BaseAPI {
    ...
    public contentfilesList(requestParameters: ContentfilesApiContentfilesListRequest, options?: RawAxiosRequestConfig) {
        return ContentfilesApiFp(this.configuration).contentfilesList(requestParameters.learning_resource_id2, requestParameters.content_feature_type, requestParameters.learning_resource_id, requestParameters.learning_resource_readable_id, requestParameters.limit, requestParameters.offered_by, requestParameters.offset, requestParameters.platform, requestParameters.run_id, requestParameters.run_readable_id, options).then((request) => request(this.axios, this.basePath));
    }
...
export const CoursesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        coursesContentfilesList: async (learning_resource_id2: number, content_feature_type?: string, learning_resource_id?: number, learning_resource_readable_id?: string, limit?: number, offered_by?: CoursesContentfilesListOfferedByEnum, offset?: number, platform?: CoursesContentfilesListPlatformEnum, run_id?: number, run_readable_id?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'learning_resource_id2' is not null or undefined
            assertParamExists('coursesContentfilesList', 'learning_resource_id2', learning_resource_id2)
         ...
         * @throws {RequiredError}
         */
        coursesList: async (course_feature?: string, department?: CoursesListDepartmentEnum, level?: CoursesListLevelEnum, limit?: number, offered_by?: CoursesListOfferedByEnum, offset?: number, platform?: CoursesListPlatformEnum, professional?: boolean, resource_type?: CoursesListResourceTypeEnum, sortby?: CoursesListSortbyEnum, topic?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        coursesNewList: async (course_feature?: string, department?: CoursesNewListDepartmentEnum, level?: CoursesNewListLevelEnum, limit?: number, offered_by?: CoursesNewListOfferedByEnum, offset?: number, platform?: CoursesNewListPlatformEnum, professional?: boolean, resource_type?: CoursesNewListResourceTypeEnum, sortby?: CoursesNewListSortbyEnum, topic?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        coursesUpcomingList: async (course_feature?: string, department?: CoursesUpcomingListDepartmentEnum, level?: CoursesUpcomingListLevelEnum, limit?: number, offered_by?: CoursesUpcomingListOfferedByEnum, offset?: number, platform?: CoursesUpcomingListPlatformEnum, professional?: boolean, resource_type?: CoursesUpcomingListResourceTypeEnum, sortby?: CoursesUpcomingListSortbyEnum, topic?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CoursesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async coursesContentfilesList(learning_resource_id2: number, content_feature_type?: string, learning_resource_id?: number, learning_resource_readable_id?: string, limit?: number, offered_by?: CoursesContentfilesListOfferedByEnum, offset?: number, platform?: CoursesContentfilesListPlatformEnum, run_id?: number, run_readable_id?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedContentFileList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.coursesContentfilesList(learning_resource_id2, content_feature_type, learning_resource_id, learning_resource_readable_id, limit, offered_by, offset, platform, run_id, run_readable_id, options);
            const index = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async coursesList(course_feature?: string, department?: CoursesListDepartmentEnum, level?: CoursesListLevelEnum, limit?: number, offered_by?: CoursesListOfferedByEnum, offset?: number, platform?: CoursesListPlatformEnum, professional?: boolean, resource_type?: CoursesListResourceTypeEnum, sortby?: CoursesListSortbyEnum, topic?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedCourseResourceList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.coursesList(course_feature, department, level, limit, offered_by, offset, platform, professional, resource_type, sortby, topic, options);
            const index = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async coursesNewList(course_feature?: string, department?: CoursesNewListDepartmentEnum, level?: CoursesNewListLevelEnum, limit?: number, offered_by?: CoursesNewListOfferedByEnum, offset?: number, platform?: CoursesNewListPlatformEnum, professional?: boolean, resource_type?: CoursesNewListResourceTypeEnum, sortby?: CoursesNewListSortbyEnum, topic?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedCourseResourceList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.coursesNewList(course_feature, department, level, limit, offered_by, offset, platform, professional, resource_type, sortby, topic, options);
            const index = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async coursesUpcomingList(course_feature?: string, department?: CoursesUpcomingListDepartmentEnum, level?: CoursesUpcomingListLevelEnum, limit?: number, offered_by?: CoursesUpcomingListOfferedByEnum, offset?: number, platform?: CoursesUpcomingListPlatformEnum, professional?: boolean, resource_type?: CoursesUpcomingListResourceTypeEnum, sortby?: CoursesUpcomingListSortbyEnum, topic?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedCourseResourceList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.coursesUpcomingList(course_feature, department, level, limit, offered_by, offset, platform, professional, resource_type, sortby, topic, options);
            const index = configuration?.serverIndex ?? 0;
...
export const CoursesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        coursesContentfilesList(requestParameters: CoursesApiCoursesContentfilesListRequest, options?: RawAxiosRequestConfig): AxiosPromise<PaginatedContentFileList> {
            return localVarFp.coursesContentfilesList(requestParameters.learning_resource_id2, requestParameters.content_feature_type, requestParameters.learning_resource_id, requestParameters.learning_resource_readable_id, requestParameters.limit, requestParameters.offered_by, requestParameters.offset, requestParameters.platform, requestParameters.run_id, requestParameters.run_readable_id, options).then((request) => request(axios, basePath));
        },
        /**
         * Show content files for a learning resource
         * @summary Learning Resource Content File Retrieve
...
export const LearningResourcesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        learningResourcesContentfilesList: async (learning_resource_id2: number, content_feature_type?: string, learning_resource_id?: number, learning_resource_readable_id?: string, limit?: number, offered_by?: LearningResourcesContentfilesListOfferedByEnum, offset?: number, platform?: LearningResourcesContentfilesListPlatformEnum, run_id?: number, run_readable_id?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'learning_resource_id2' is not null or undefined
            assertParamExists('learningResourcesContentfilesList', 'learning_resource_id2', learning_resource_id2)
         ...
         * @throws {RequiredError}
         */
        learningResourcesList: async (course_feature?: string, department?: LearningResourcesListDepartmentEnum, level?: LearningResourcesListLevelEnum, limit?: number, offered_by?: LearningResourcesListOfferedByEnum, offset?: number, platform?: LearningResourcesListPlatformEnum, professional?: boolean, resource_type?: LearningResourcesListResourceTypeEnum, sortby?: LearningResourcesListSortbyEnum, topic?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        learningResourcesNewList: async (course_feature?: string, department?: LearningResourcesNewListDepartmentEnum, level?: LearningResourcesNewListLevelEnum, limit?: number, offered_by?: LearningResourcesNewListOfferedByEnum, offset?: number, platform?: LearningResourcesNewListPlatformEnum, professional?: boolean, resource_type?: LearningResourcesNewListResourceTypeEnum, sortby?: LearningResourcesNewListSortbyEnum, topic?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        learningResourcesUpcomingList: async (course_feature?: string, department?: LearningResourcesUpcomingListDepartmentEnum, level?: LearningResourcesUpcomingListLevelEnum, limit?: number, offered_by?: LearningResourcesUpcomingListOfferedByEnum, offset?: number, platform?: LearningResourcesUpcomingListPlatformEnum, professional?: boolean, resource_type?: LearningResourcesUpcomingListResourceTypeEnum, sortby?: LearningResourcesUpcomingListSortbyEnum, topic?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const LearningResourcesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async learningResourcesContentfilesList(learning_resource_id2: number, content_feature_type?: string, learning_resource_id?: number, learning_resource_readable_id?: string, limit?: number, offered_by?: LearningResourcesContentfilesListOfferedByEnum, offset?: number, platform?: LearningResourcesContentfilesListPlatformEnum, run_id?: number, run_readable_id?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedContentFileList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.learningResourcesContentfilesList(learning_resource_id2, content_feature_type, learning_resource_id, learning_resource_readable_id, limit, offered_by, offset, platform, run_id, run_readable_id, options);
            const index = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async learningResourcesList(course_feature?: string, department?: LearningResourcesListDepartmentEnum, level?: LearningResourcesListLevelEnum, limit?: number, offered_by?: LearningResourcesListOfferedByEnum, offset?: number, platform?: LearningResourcesListPlatformEnum, professional?: boolean, resource_type?: LearningResourcesListResourceTypeEnum, sortby?: LearningResourcesListSortbyEnum, topic?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedLearningResourceList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.learningResourcesList(course_feature, department, level, limit, offered_by, offset, platform, professional, resource_type, sortby, topic, options);
            const index = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async learningResourcesNewList(course_feature?: string, department?: LearningResourcesNewListDepartmentEnum, level?: LearningResourcesNewListLevelEnum, limit?: number, offered_by?: LearningResourcesNewListOfferedByEnum, offset?: number, platform?: LearningResourcesNewListPlatformEnum, professional?: boolean, resource_type?: LearningResourcesNewListResourceTypeEnum, sortby?: LearningResourcesNewListSortbyEnum, topic?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedLearningResourceList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.learningResourcesNewList(course_feature, department, level, limit, offered_by, offset, platform, professional, resource_type, sortby, topic, options);
            const index = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async learningResourcesUpcomingList(course_feature?: string, department?: LearningResourcesUpcomingListDepartmentEnum, level?: LearningResourcesUpcomingListLevelEnum, limit?: number, offered_by?: LearningResourcesUpcomingListOfferedByEnum, offset?: number, platform?: LearningResourcesUpcomingListPlatformEnum, professional?: boolean, resource_type?: LearningResourcesUpcomingListResourceTypeEnum, sortby?: LearningResourcesUpcomingListSortbyEnum, topic?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedLearningResourceList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.learningResourcesUpcomingList(course_feature, department, level, limit, offered_by, offset, platform, professional, resource_type, sortby, topic, options);
            const index = configuration?.serverIndex ?? 0;
...
export class LearningResourcesApi extends BaseAPI {
    ...
    public learningResourcesContentfilesList(requestParameters: LearningResourcesApiLearningResourcesContentfilesListRequest, options?: RawAxiosRequestConfig) {
        return LearningResourcesApiFp(this.configuration).learningResourcesContentfilesList(requestParameters.learning_resource_id2, requestParameters.content_feature_type, requestParameters.learning_resource_id, requestParameters.learning_resource_readable_id, requestParameters.limit, requestParameters.offered_by, requestParameters.offset, requestParameters.platform, requestParameters.run_id, requestParameters.run_readable_id, options).then((request) => request(this.axios, this.basePath));
    }
...
export const LearningResourcesSearchApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async learningResourcesSearchRetrieve(aggregations?: Array<LearningResourcesSearchRetrieveAggregationsEnum>, certification?: boolean | null, course_feature?: Array<string>, department?: Array<LearningResourcesSearchRetrieveDepartmentEnum>, id?: Array<number>, level?: Array<LearningResourcesSearchRetrieveLevelEnum>, limit?: number, offered_by?: Array<LearningResourcesSearchRetrieveOfferedByEnum>, offset?: number, platform?: Array<LearningResourcesSearchRetrievePlatformEnum>, professional?: boolean | null, q?: string, resource_type?: Array<LearningResourcesSearchRetrieveResourceTypeEnum>, sortby?: LearningResourcesSearchRetrieveSortbyEnum, topic?: Array<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SearchResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.learningResourcesSearchRetrieve(aggregations, certification, course_feature, department, id, level, limit, offered_by, offset, platform, professional, q, resource_type, sortby, topic, options);
            const index = configuration?.serverIndex ?? 0;
...
export const LearningResourcesSearchApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        learningResourcesSearchRetrieve(requestParameters: LearningResourcesSearchApiLearningResourcesSearchRetrieveRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<SearchResponse> {
...
export const LearningpathsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        learningpathsList: async (course_feature?: string, department?: LearningpathsListDepartmentEnum, level?: LearningpathsListLevelEnum, limit?: number, offered_by?: LearningpathsListOfferedByEnum, offset?: number, platform?: LearningpathsListPlatformEnum, professional?: boolean, resource_type?: LearningpathsListResourceTypeEnum, sortby?: LearningpathsListSortbyEnum, topic?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/learningpaths/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const LearningpathsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async learningpathsList(course_feature?: string, department?: LearningpathsListDepartmentEnum, level?: LearningpathsListLevelEnum, limit?: number, offered_by?: LearningpathsListOfferedByEnum, offset?: number, platform?: LearningpathsListPlatformEnum, professional?: boolean, resource_type?: LearningpathsListResourceTypeEnum, sortby?: LearningpathsListSortbyEnum, topic?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedLearningPathResourceList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.learningpathsList(course_feature, department, level, limit, offered_by, offset, platform, professional, resource_type, sortby, topic, options);
            const index = configuration?.serverIndex ?? 0;
...
export const PodcastEpisodesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        podcastEpisodesList: async (course_feature?: string, department?: PodcastEpisodesListDepartmentEnum, level?: PodcastEpisodesListLevelEnum, limit?: number, offered_by?: PodcastEpisodesListOfferedByEnum, offset?: number, platform?: PodcastEpisodesListPlatformEnum, professional?: boolean, resource_type?: PodcastEpisodesListResourceTypeEnum, sortby?: PodcastEpisodesListSortbyEnum, topic?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const PodcastEpisodesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async podcastEpisodesList(course_feature?: string, department?: PodcastEpisodesListDepartmentEnum, level?: PodcastEpisodesListLevelEnum, limit?: number, offered_by?: PodcastEpisodesListOfferedByEnum, offset?: number, platform?: PodcastEpisodesListPlatformEnum, professional?: boolean, resource_type?: PodcastEpisodesListResourceTypeEnum, sortby?: PodcastEpisodesListSortbyEnum, topic?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedPodcastEpisodeResourceList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.podcastEpisodesList(course_feature, department, level, limit, offered_by, offset, platform, professional, resource_type, sortby, topic, options);
            const index = configuration?.serverIndex ?? 0;
...
export const PodcastsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        podcastsList: async (course_feature?: string, department?: PodcastsListDepartmentEnum, level?: PodcastsListLevelEnum, limit?: number, offered_by?: PodcastsListOfferedByEnum, offset?: number, platform?: PodcastsListPlatformEnum, professional?: boolean, resource_type?: PodcastsListResourceTypeEnum, sortby?: PodcastsListSortbyEnum, topic?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const PodcastsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async podcastsList(course_feature?: string, department?: PodcastsListDepartmentEnum, level?: PodcastsListLevelEnum, limit?: number, offered_by?: PodcastsListOfferedByEnum, offset?: number, platform?: PodcastsListPlatformEnum, professional?: boolean, resource_type?: PodcastsListResourceTypeEnum, sortby?: PodcastsListSortbyEnum, topic?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedPodcastResourceList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.podcastsList(course_feature, department, level, limit, offered_by, offset, platform, professional, resource_type, sortby, topic, options);
            const index = configuration?.serverIndex ?? 0;
...
export const ProgramsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        programsList: async (course_feature?: string, department?: ProgramsListDepartmentEnum, level?: ProgramsListLevelEnum, limit?: number, offered_by?: ProgramsListOfferedByEnum, offset?: number, platform?: ProgramsListPlatformEnum, professional?: boolean, resource_type?: ProgramsListResourceTypeEnum, sortby?: ProgramsListSortbyEnum, topic?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        programsNewList: async (course_feature?: string, department?: ProgramsNewListDepartmentEnum, level?: ProgramsNewListLevelEnum, limit?: number, offered_by?: ProgramsNewListOfferedByEnum, offset?: number, platform?: ProgramsNewListPlatformEnum, professional?: boolean, resource_type?: ProgramsNewListResourceTypeEnum, sortby?: ProgramsNewListSortbyEnum, topic?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        programsUpcomingList: async (course_feature?: string, department?: ProgramsUpcomingListDepartmentEnum, level?: ProgramsUpcomingListLevelEnum, limit?: number, offered_by?: ProgramsUpcomingListOfferedByEnum, offset?: number, platform?: ProgramsUpcomingListPlatformEnum, professional?: boolean, resource_type?: ProgramsUpcomingListResourceTypeEnum, sortby?: ProgramsUpcomingListSortbyEnum, topic?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ProgramsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async programsList(course_feature?: string, department?: ProgramsListDepartmentEnum, level?: ProgramsListLevelEnum, limit?: number, offered_by?: ProgramsListOfferedByEnum, offset?: number, platform?: ProgramsListPlatformEnum, professional?: boolean, resource_type?: ProgramsListResourceTypeEnum, sortby?: ProgramsListSortbyEnum, topic?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedProgramResourceList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.programsList(course_feature, department, level, limit, offered_by, offset, platform, professional, resource_type, sortby, topic, options);
            const index = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async programsNewList(course_feature?: string, department?: ProgramsNewListDepartmentEnum, level?: ProgramsNewListLevelEnum, limit?: number, offered_by?: ProgramsNewListOfferedByEnum, offset?: number, platform?: ProgramsNewListPlatformEnum, professional?: boolean, resource_type?: ProgramsNewListResourceTypeEnum, sortby?: ProgramsNewListSortbyEnum, topic?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedProgramResourceList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.programsNewList(course_feature, department, level, limit, offered_by, offset, platform, professional, resource_type, sortby, topic, options);
            const index = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async programsUpcomingList(course_feature?: string, department?: ProgramsUpcomingListDepartmentEnum, level?: ProgramsUpcomingListLevelEnum, limit?: number, offered_by?: ProgramsUpcomingListOfferedByEnum, offset?: number, platform?: ProgramsUpcomingListPlatformEnum, professional?: boolean, resource_type?: ProgramsUpcomingListResourceTypeEnum, sortby?: ProgramsUpcomingListSortbyEnum, topic?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedProgramResourceList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.programsUpcomingList(course_feature, department, level, limit, offered_by, offset, platform, professional, resource_type, sortby, topic, options);
            const index = configuration?.serverIndex ?? 0;
